...
# "   5) optuna_*        :: use TPE algorithm by optuna API (*=rms/mad)
...
# "   9) cmaes_*         :: use CMAES algorithm based on * (*=rms/mad)       "
__optimization algorithm__ :: cmaes_rms
...
#__rest_batch_type__ :: queue bsub rest_251027.sif small
#__rest_ :: <1> <2>
#    <1>: thread number
#    <2>: rest cmd name
__rest__ ::  32   #核数 调用rest版本
     xc =                        "xygjos" 
     frozen_core_postscf =        0 
     basis_path =                "/home/symei/basis/br/TZVPP-10-o-all" # For serial type, path in your container should be used
...
# "  0) AngM  :: fit coeff and exp of same angular momentum together   "
...
# "  4) manual  :: fit parameters selected manually                    "
__pseudo_mod__  :: all
...
__pseudo_property__  ::  gexp          1
# These two position settings are only needed when manual mod is applied
__coeff position__  ::   
__gexp position__  :: 
__basis_dir__  ::/share/home/symei/basis/br/TZVPP-10-o-all/Br.json
__initial guess__ :: 
...
"======================== precondition part ========================="
"   This part is to rescale the fitting parameter to improve     "
"   optimization process                                         "
"   0) auto :: use L-BFGS-B to estimate Hessian matrix, then generate"
"      the rescaling array"
"   1) all   :: rescale all the coeff and gexp"
"   2) coeff :: "
"   3) gexp  :: "
"   4) angm  :: "
"   5) manual:: "
