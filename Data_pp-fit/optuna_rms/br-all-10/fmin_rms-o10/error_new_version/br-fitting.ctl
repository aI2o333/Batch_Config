...
# "   6) optuna_rms      ::
# "   7) optuna_mad      ::
# "   8) gbasis          :: generate basis without calculation               "
...
__rest__ ::  8   #核数 调用rest版本
     ...
     basis_path =                "/home/symei/TZVPP-10-o-all" # For serial type, path in your container should be used
...
__basis_dir__  ::/share/home/symei/TZVPP-10-o-all/Br.json
__initial guess__ ::
