=>Fitting start from Wed Nov 19 22:28:57 2025
...
=>Initial Guess
  1.46435890E+01  1.44923898E+02  2.55916953E+01  2.30245676E+01  2.97227782E+01
  1.66345275E+01
=>Optimization Algorithm employed is batch
=>Pseudopotential fitting mod is manual
  Revised basis dir :/share/home/symei/basis/br/TZVPP-10-o-all/Br.json
=>Manual coeff position set to [1, 2, 3]
=>Manual gexp position set to [1, 2, 3]
...
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :    -418.41794954
=>The (R)-xDH Energy          :    -417.74689295
=>Error :: AI Correction result was not found in br
=>AI Correction               :              NAN
=>The direction of basis set is required
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :    -836.91418430
=>The (R)-xDH Energy          :    -835.57301105
...
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :    -458.39227077
=>The (R)-xDH Energy          :    -457.60899337
=>Error :: AI Correction result was not found in ch3br
=>AI Correction               :              NAN
=>The direction of basis set is required
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :    -876.24463161
=>The (R)-xDH Energy          :    -874.79899692
=>Error :: AI Correction result was not found in ch2br2
=>AI Correction               :              NAN
=>The direction of basis set is required
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :   -1294.09372554
=>The (R)-xDH Energy          :   -1291.98665002
=>Error :: AI Correction result was not found in chbr3
=>AI Correction               :              NAN
=>The direction of basis set is required
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :   -1711.93714254
=>The (R)-xDH Energy          :   -1709.17030833
...
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :    -653.83532188
=>The (R)-xDH Energy          :    -652.52232435
...
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :    -537.05433479
=>The (R)-xDH Energy          :    -536.05375845
=>Error :: AI Correction result was not found in cccbr1
=>AI Correction               :              NAN
=>The direction of basis set is required
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :    -419.06348443
=>The (R)-xDH Energy          :    -418.39153771
...
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :    -915.58290471
=>The (R)-xDH Energy          :    -914.02874665
...
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :    -954.91154017
=>The (R)-xDH Energy          :    -953.25168430
...
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :    -994.24580688
=>The (R)-xDH Energy          :    -992.47856418
=>Error :: AI Correction result was not found in c-cbrcbr-c
=>AI Correction               :              NAN
=>The direction of basis set is required
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :    -580.83783692
=>The (R)-xDH Energy          :    -579.86408891
=>Error :: AI Correction result was not found in nabr
=>AI Correction               :              NAN
=>The direction of basis set is required
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :    -878.66925707
=>The (R)-xDH Energy          :    -877.52023281
...
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :    -494.27280508
=>The (R)-xDH Energy          :    -493.42654280
...
=>Basis set dir: 
=>This is a batch job for energy calculation
=>The SCF energy              :   -1596.83644027
=>The (R)-xDH Energy          :   -1594.41426037
...
=>Batch corresponds to these parameters ::
  ...
  1.66345275E+01
==----------------------------------------------------------------------------==
=>        AD =      -0.69363265;        wAD =      -0.69363265
=>       MAD =       1.31325102;       wMAD =       1.31325102
=>       RMS =       1.61575426;       wRMS =       1.61575426
==----------------------------------------------------------------------------==
=>Statistic result of energy :
==----------------------------------------------------------------------------==
                        Name       Reference    Calc. Result    Deviation Weight
--------------------------------------------------------------------------------
                1*2th->2*1th     49.53741130     49.71457576         0.18   1.00
      1*3th+1*2th->1*4th+...     -7.52038130     -5.73534432         1.79   1.00
      1*4th+1*2th->1*5th+...     -5.58537376     -5.35279841         0.23   1.00
      1*5th+1*2th->1*6th+...     -2.84437074     -3.87786427        -1.03   1.00
      1*6th+1*2th->1*7th+...      0.92445978     -1.37109586        -2.30   1.00
      1*8th+1*2th->1*9th+...    -14.35532087    -13.81719314         0.54   1.00
      1*10th+1*2th->1*11t...    -11.26635075    -10.10100450         1.17   1.00
      1*2th+1*23th->1*12t...     26.00499984     26.28499694         0.28   1.00
        1*13th+1*2th->1*14th    -34.24793895    -35.41427817        -1.17   1.00
        1*15th+1*2th->1*16th    -32.18526018    -34.22945426        -2.04   1.00
        1*17th+1*2th->1*18th    -34.66754848    -37.17953847        -2.51   1.00
         1*12th->1*1th+1*0th     93.13507599     91.50721534        -1.63   1.00
        1*20th->1*1th+1*21th     52.86891931     53.33780921         0.47   1.00
        1*19th->1*1th+1*22th     86.80595221     83.28805265        -3.52   1.00
        1*25th+3*1th->1*26th   -192.29949008   -193.15378495        -0.85   1.00
--------------------------------------------------------------------------------
        AD =        -0.69363265
       MAD =         1.31325102
       RMS =         0.41718595
      ...
      wRMS =         0.41718595
==----------------------------------------------------------------------------==
=>Total job time:     209.32(wall)
=>Fitting end at Wed Nov 19 22:32:27 2025
=>----------------------------------------------------------------------------==
  #Filename:  DFT_Fit
