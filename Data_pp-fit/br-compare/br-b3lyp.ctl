...
__rest__ ::  4   #核数 调用rest版本
     ...
     basis_path =                "/home/symei/def2-TZVPP-mixed" # For serial type, path in your container should be used
...
__pseudo_property__  ::  gexp           2
__basis_dir__  :: /share/home/symei/def2-TZVPP-mixed/Br.json
__initial guess__ ::
...
#"Flag"         "DIR"                        "InpName"       "JobType
              h    <PATH1>/br-simu                    h           energy
             br    <PATH1>/br-simu                   br           energy
            br2    <PATH1>/br-simu                  br2           energy
            ch4    <PATH1>/br-simu                  ch4           energy
          ch3br    <PATH1>/br-simu                ch3br           energy
         ch2br2    <PATH1>/br-simu               ch2br2           energy
          chbr3    <PATH1>/br-simu                chbr3           energy
           cbr4    <PATH1>/br-simu                 cbr4           energy
        ring-c6    <PATH1>/br-simu              ring-c6           energy
     ring-c6br1    <PATH1>/br-simu           ring-c6br1           energy
            ccc    <PATH1>/br-simu                  ccc           energy
         cccbr1    <PATH1>/br-simu               cccbr1           energy
            hbr    <PATH1>/br-simu                  hbr           energy
            c=c    <PATH1>/br-simu                  c=c           energy
         cbrcbr    <PATH1>/br-simu               cbrcbr           energy
           cc=c    <PATH1>/br-simu                 cc=c           energy
       c-cbrcbr    <PATH1>/br-simu             c-cbrcbr           energy
          cc=cc    <PATH1>/br-simu                cc=cc           energy
     c-cbrcbr-c    <PATH1>/br-simu           c-cbrcbr-c           energy
           nabr    <PATH1>/br-simu                 nabr           energy
           brcl    <PATH1>/br-simu                 brcl           energy
             cl    <PATH1>/br-simu                   cl           energy
             na    <PATH1>/br-simu                   na           energy
            h2o    <PATH1>/br-simu                  h2o           energy
           hobr    <PATH1>/br-simu                 hobr           energy
              p    <PATH1>/br-simu                    p           energy
           pbr3    <PATH1>/br-simu                 pbr3           energy
