...
__rest__ ::  8   #核数 调用rest版本
     ...
     basis_path =                "/home/symei/def2-TZVPP-new-mixed" # For serial type, path in your container should be used
...
# "  3) all     :: fit all parameters at the same time                 "
__pseudo_mod__  :: all
...
__basis_dir__  :: /share/home/symei/def2-TZVPP-new-mixed/Br.json
__initial guess__ ::
...
2    br2       -1     br       2                                           49.5374113    1.000
4    ch4       -1     br2     -1      ch3br           1      hbr      1   -7.5203813     1.000
...
3    p          -1    br      -3      pbr3            1                   -192.2994901   1.000
